...
import { Input, Mask } from "../Components/CustomComponents";
...
export default function Cadastro({ip}) {
  ...
  const handleCadastro = async (data) => {
    const isValid = await cadastroSchema.isValid(data);
        ...
        await axios
          ...
          .catch((error) => {
            setModalData({
              ...
              errorDescription: "Usuário já cadastrado!"
            });
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="px-8 py-6 mt-4 text-left bg-white shadow-lg">
        ...
        <h1 className="font-Tw  text-lg flex justify-center py-6 ">Cadastro de Cliente</h1>
          <div className="">
            <Input
              onChange={onChange}
              type="text"
...
export async function setModalData({ err }){
  const setmd = err.setModalData[""]
    return {
      errorCode: "",
      errorMessage: "Não foi possível cadastrar o usuário",
      errorDescription: "Usuário já cadastrado!"
