...
import { Box, Title } from "../Components/CustomComponents";
...
function Index() {
  ...
  const { data } = useSession();
    return (
        <>
        <Box notShow>
        <Title path="/boleto" title={data?.user?.name} col3/>
                                ...
                                <td className="pl-4 cursor-pointer">
                                    <div className="flex items-center">
                                        ...
                                        <div className="pl-4">
                                            ...
                                            <p className="text-xs leading-3 text-gray-600 pt-2">OKon Inc</p>
                                        </div>
                                    </div>
                                </td>
                                <td className="pl-12">
